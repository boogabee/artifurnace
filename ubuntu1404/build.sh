...
apt-get update -y
apt-get install -y git bison flex build-essential libxml2 libxml2-dev libncurses5 libncurses5-dev libxslt-dev libbz2-dev libldap2-dev libreadline-dev libcurl4-openssl-dev libyaml-dev libevent-dev checkinstall wget
...
GPDB_PACKAGE_NAME=apache-greenplum-db-${BUILD_VERSION}-${BUILD_NUMBER}-UBUNTU1404-x86_64
